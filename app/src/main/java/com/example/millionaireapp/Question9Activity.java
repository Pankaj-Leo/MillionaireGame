...
public class Question9Activity extends BaseQuestionActivity {
    ...
    protected Class<?> getNextQuestionActivityClass() {
        ...
        return Question10Activity.class; // Assuming you have more questions. Change as necessary.
    }
    ...
    protected String getQuestionText() {
        return "What is the capital city of Australia?";
    }

    @Override
    protected String[] getAnswers() {
        return new String[]{"Sydney", "Melbourne", "Canberra", "Perth"};
    }
